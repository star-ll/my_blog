---
{"publish":true,"created":"2026-09-19T20:19:57.223+08:00","modified":"2026-09-19T22:05:30.375+08:00","cssclasses":""}
---
...
![Causal attention mask: each token can use only itself and earlier tokens](./attachmens/llm-01-causal-mask.svg)

## 从文本到模型输入

![From text to token IDs and embedding vectors](./attachmens/llm-02-tokenization-embedding.svg)
...
![LM Head maps the last hidden state to logits and sampling selects the next token](./attachmens/llm-03-lm-head-sampling.svg)
...
![Autoregressive generation: predict, append, and repeat until a stop condition](./attachmens/llm-04-autoregressive-loop.svg)
...
![The full inference path from text to the next token](./attachmens/llm-05-inference-pipeline.svg)
